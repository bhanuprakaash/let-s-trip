...
const TravelEssentials = ({
    ...
    return filteredFlights.map((flight, index) => (
      <div key={index} className="col-md-12">
        <p className="mbr-text mbr-fonts-style display-7">
          ...
          <br />
          <strong>Departure:</strong> {flight.departure.city},{" "}
          {flight.departure.airport} - {flight.departure.time}
          <br />
          <strong>Arrival:</strong> {flight.arrival.city},{" "}
    ...
    return filteredTrains.map((train, index) => (
      <div key={index} className="col-md-12">
        <p className="mbr-text mbr-fonts-style display-7">
          ...
          <br />
          <strong>Departure:</strong> {train.departure.city},{" "}
          {train.departure.station} - {train.departure.time}
          <br />
          <strong>Arrival:</strong> {train.arrival.city},{" "}
          {train.arrival.station} - {train.arrival.time}
          <br />
  ...
  return (
    <section
      className="tabs content18 cid-ukM100hYSr"
      id="tabs1-2x"
            ...
            <div className="item-wrapper">
              ...
              <div className="tab-content">
                <div
                  id="tab1"
                  className={`tab-pane ${
                    activeTab === "tab1" ? "in active" : ""
                  }`}
                  role="tabpanel"
                >
                  <div className="row">{renderFlights()}</div>
                </div>
                <div
                  id="tab2"
                  className={`tab-pane ${
                    activeTab === "tab2" ? "in active" : ""
                  }`}
                  role="tabpanel"
                >
                  <div className="row">{renderTrains()}</div>
                </div>
                <div
                  id="tab3"
                  className={`tab-pane ${
                    activeTab === "tab3" ? "in active" : ""
                  }`}
                  role="tabpanel"
                >
                  <div className="row">{renderBuses()}</div>
                </div>
                <div
                  id="tab4"
                  className={`tab-pane ${
                    activeTab === "tab4" ? "in active" : ""
                  }`}
                  role="tabpanel"
                >
                  <div className="row">{renderAccommodations()}</div>
                </div>
              </div>
            </div>
          </div>
