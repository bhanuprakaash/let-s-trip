    ...
    <section className="draggable-body">
      ...
      <div className="form-container">
        <form id="trip-form" onSubmit={handleSubmit}>
          <input
            ...
            ref={(el) => droppableElements.current[0] = el} // Add ref here
          />
          <FaArrowCircleRight className='destination-arrow' size={25} style={{color: "#a0e2e1"}} />
          <input
            type="text"
            id="end-destination"
            ...
            className="drag-input"
            ref={(el) => droppableElements.current[1] = el} // Add ref here
          />
           <input
            type="number"
            id="num-days"
      ...
      <div className="destinations-container">
        ...
        <ul id="destinations-list">
          {['Agra', 'Jaipur', 'Delhi', 'Mumbai', 'Bangalore', 'Chennai', 'Kolkata', 'Hyderabad', 'Goa', 'Varanasi', 'Udaipur', 'Shimla', 'Manali', 'Kerala', 'Leh', 'Ladakh', 'Coorg'].map((destination, index) => (
            <li
              key={index}
              draggable="true"
